...
V2rayU 是一款 V2Ray macOS 客户端，用于科学上网，使用 Swift 4.2 编写，基于 V2Ray 项目，支持 vmess，shadowsocks，socks5 等服务协议（推荐搭建**v2ray 服务**，可伪装成正常网站，防封锁)，支持二维码，剪贴板导入，手动配置，二维码分享等，支持订阅，项目地址: https://github.com/yanue/V2rayU

### 主要特性
----
- **支持协议:** vmess:// 和 ss:// 和 ssr:// 协议，支持 socks5 协议
- **支持导入**: 支持二维码，粘贴板导入，本地文件及 URL 导入
...
- **支持 4.0**: 支持手动切换到 v2ray-core 4.0 以上配置格式
- **支持订阅**: <span style="color: red">支持 V2Ray 和 SS 及 SSR 订阅</span>
...
2. 无法启动或启动后无法翻墙: 
  ...
  ##### b. 查看日志
```
	V2Ray 自身日志: V2rayU -> Show logs...
	V2rayU 日志: command + 空格 搜索 console.app , 打开后搜索 V2rayU 定位错误日志
```
  #####   c. 手动启动
```
cd /Applications/V2rayU.app/Contents/Resources/
